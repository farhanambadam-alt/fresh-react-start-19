...
const SalonDetail = () => {
  ...
  return (
    <div className="min-h-screen pb-24 md:max-w-5xl md:mx-auto">
      {/* ── Hero Carousel ── */}
      ...
      <div className="hidden md:block mt-6 mx-auto px-5">
        ...
        <div className="flex justify-between mb-4">
          <button onClick={() => navigate(-1)} className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center hover:bg-secondary transition-colors">
            <ArrowLeft size={18} className="text-foreground" />
          </button>
